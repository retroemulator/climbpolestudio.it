...
const pricing: PriceSeed[] = [
  ...
  { category: "annuale", title: "Annuale Open", detail: "Tutte le lezioni che vuoi · valido fino al 27/06/2027", price: 1450, note: "Pagabile in 3 rate" },
...
async function main() {
  ...
  await client.delete({ query: '*[_type in ["discipline", "scheduleSlot", "pricingPlan"]]' });
